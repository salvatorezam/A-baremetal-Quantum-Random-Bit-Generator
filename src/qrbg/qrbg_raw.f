...
: READ-AIN0-1 RESET-I2C 83E3 WRITE-ADC-CONFIG WAIT-FOR-NEW-SAMPLE READ-ADC-CONVR ;
: PULSE-MEASURE LASER ON READ-AIN0-1 LASER OFF ;
: GET-BIT 0> IF 1 ELSE 0 THEN ;
: START-BITSTREAM BEGIN DUP PULSE-MEASURE DUP @ GET-BIT .S AGAIN ;
